          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                {
                  title: "Агропромышленное производство",
                  company: "ООО \"АПК Камский\"",
                ...
                {
                  title: "Агропромышленный холдинг",
                  company: "АО \"Агросила Холдинг\"",
              ...
              {[
                {
                  ...
                  type: "График 6/1",
                  requirements: ["Опыт работы стропальщиком", "Знание техники безопасности", "Ответственность"],
                  icon: "Unplug"
                },
                {
                  title: "Сварщик",
                  ...
                  salary: "80 000 - 85 000 ₽",
                  type: "График 6/1",
                  requirements: ["Умение пользоваться сварочным оборудованием", "Опыт работы сварщиком", "Внимательность"],
                  icon: "Flame"
                },
                {
                  title: "Слесарь МСР",
                  ...
                  type: "График 6/1",
                  requirements: ["Желание работать и развиваться", "Умение читать чертежи", "Технические навыки"],
                  icon: "Wrench"
                }
              ].map((vacancy, index) => (
